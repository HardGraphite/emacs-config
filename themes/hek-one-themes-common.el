...
(defconst hek-one--base-faces
 '((bold :weight 'bold)
   ...
   (mode-line-active    :inherit 'mode-line :box `(:color ,modeline-box :line-width (-1 . -2)))
   ...
   (org-block-begin-line         :inherit 'org-block :foreground comments :background base2 :slant 'italic)
   (org-block-end-line           :inherit 'org-block-begin-line)
   (org-checkbox                 :inherit 'org-todo)
   (org-checkbox-statistics-done :inherit 'org-done)
   (org-checkbox-statistics-todo :inherit 'org-todo)
   (org-cite                     :foreground (hek-one-blend teal fg 0.9))
   (org-cite-key                 :foreground (hek-one-blend teal fg 0.6) :underline t)
   ...
   (org-level-1                  :foreground (hek-one-lighten blue 0.3) :height 240 :underline (list :color comments :position t) :extend t) ; see `org-fontify-whole-heading-line'
   (org-level-2                  :foreground blue :height 200)
   (org-level-3                  :foreground (hek-one-darken blue 0.3) :height 180)
   (org-level-4                  :foreground (hek-one-darken blue 0.5))
   ;;;; org-agenda <built-in>
   (org-agenda-done :inherit 'org-done)
   (org-agenda-dimmed-todo-face :foreground comments)
   (org-agenda-date          :foreground violet :weight 'ultra-bold)
   (org-agenda-date-today    :foreground (hek-one-lighten violet 0.4)   :weight 'ultra-bold)
   (org-agenda-date-weekend  :foreground (hek-one-darken violet 0.4)  :weight 'ultra-bold)
   (org-agenda-structure     :foreground fg :weight 'ultra-bold)
   (org-agenda-clocking      :background (hek-one-blend blue bg 0.2))
   (org-upcoming-deadline         :foreground (hek-one-blend fg bg 0.8))
   (org-upcoming-distant-deadline :foreground (hek-one-blend fg bg 0.5))
